...
//        transcoder.addTranscodingHint(PNGTranscoder.KEY_WIDTH, (float) 500);
//        transcoder.addTranscodingHint(PNGTranscoder.KEY_HEIGHT, (float) 500);
    ...
    public static void removeLabels(Node parent) {
